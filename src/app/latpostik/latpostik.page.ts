...
@Component({
  selector: 'app-latpostik',
  templateUrl: './latpostik.page.html',
  styleUrls: ['./latpostik.page.scss'],
})
export class LatpostikPage implements OnInit {
